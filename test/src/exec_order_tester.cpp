...
int exec_Test(const std::vector<Node> &result, const std::string &output_Name, long total_Memory);
int main() {
    ...
    printf("Total time small_test_1: %d", exec_Test(small_Test_1_Solution, /* outputName*/, sm_Test_Data.max_memory));
}
/**
